...
<body class="bg-primary d-flex flex-column vh-100">
    ...
    <div class="container text-center">
        ...
        <form id="converterForm" class="align-items-center">
            <label class="fs-3 fw-bold " for="baseType">Selecciona el tipo de numero:</label>
            <div class="row justify-content-center pt-3">
                <div class="col-md-6">
                    <select id="baseType" class="form-select form-select-lg "
            ...
            <label for="inputNumber" class="fuente-Abel fs-2 pt-3">Ingresa el numero:</label>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <input type="text" id="inputNumber" class="form-control my-3 custom-border">
                    </div>
                </div>
            </div>

            <button class="btn btn-success bg-accent fuente-Abel" type="button"
                onclick="convertNumber()">CONVERTIR</button>
        </form>
        <hr>
        <div id="result" class="fuente-Abel fs-4 text-secondary fw-bold">
